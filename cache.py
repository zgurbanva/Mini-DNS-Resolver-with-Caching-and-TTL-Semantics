"""In-memory DNS cache with TTL-aware positive and negative (NXDOMAIN) entries."""
...
class DNSCache:
    """Keyed by (canonical qname, rdtype). Lazy eviction on access."""
    ...
    def __init__(
        ...
        *,
        ...
        self._positive: dict[tuple[dns.name.Name, int], PositiveCacheEntry] = {}
        self._negative: dict[tuple[dns.name.Name, int], NegativeCacheEntry] = {}
